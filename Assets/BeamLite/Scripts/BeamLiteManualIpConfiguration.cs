...
namespace HoloToolkit.Sharing.Utilities
{
    ...
    /// </summary>
    public class BeamLiteManualIpConfiguration : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ipAddress.text = PlayerPrefs.GetString("SharingServerIp", "141.99.199.219");
            firstRun = true;
        }
        ...
        public void ConnectToSharingService()
        {
            ...
            NetworkManager.ServerAddressIsSet = true;
