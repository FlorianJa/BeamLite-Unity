...
public class BeamLiteHlapiPlayer : NetworkBehaviour, IDissonancePlayer
{
    /// <summary>
    /// The real position of the avatar (sound source)
    /// </summary>
    public GameObject Avatar;

    private static readonly Log Log = Logs.Create(LogCategory.Network, "Custom HLAPI Player Component");
    ...
    {
        get { return Avatar.transform.rotation; }
    }
    ...
    public void OnEnable()
    {
        ...
        //create a new game object for the avatar to provide a valid game object before the avatar object is set by the spawn function in the networkplayer class
